...
| `--disable-default-ignore-patterns`                         | `DISABLE_DEFAULT_IGNORE_PATTERNS`                         | `false` | Disable the built-in default diff ignore patterns (caBundle, tls.cert, checksums etc.)                                       |
