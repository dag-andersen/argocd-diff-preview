...
If you repository is public and only uses public Helm Charts, you can use the following GitHub Actions workflow to generate a diff between the main branch and the pull request branch. The diff is then posted as a comment on the pull request.
