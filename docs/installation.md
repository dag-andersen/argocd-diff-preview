...
=== "Docker"
    ...
    docker run \
      ...
      -e REPO=<owner>/<repo>  \
      dagandersen/argocd-diff-preview:v0.0.34
    ```
...
=== "Binary"
    ...
    *Example for downloading and running on macOS:*
    ...
    ```bash
    curl -LJO https://github.com/dag-andersen/argocd-diff-preview/releases/download/v0.0.34/argocd-diff-preview-Darwin-x86_64.tar.gz
