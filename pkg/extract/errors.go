...
var helpMessages = map[ErrorKind]string{
	ErrorClusterVersionFailed: "This error usually happens if your cluster is configured with 'createClusterRoles: false' and '--render-method=server-api' is not set",
	ErrorClusterScopeRBAC:     "This error usually happens if your cluster is configured with 'createClusterRoles: false' and '--render-method=server-api' is not set",
}
