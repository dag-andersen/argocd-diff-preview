...
>    dagandersen/argocd-diff-preview:v0.0.14
> ```
> 
...
```bash
curl -LJO https://github.com/dag-andersen/argocd-diff-preview/releases/download/v0.0.14/argocd-diff-preview-Darwin-x86_64.tar.gz
